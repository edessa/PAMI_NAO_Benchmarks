...
import torch
sys.path.append("..")
from next_active_object_flow import FCN8s, CustomDataset
...
checkpoint = torch.load('../weights/weights/nao_flow.pt')
...
test_dataset = CustomDataset(image_val_data, flow_val_data, mask_val_data, clip_length=3, train=True)
